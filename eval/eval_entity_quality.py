...
class EntityEvaluator:
    ...
    def __init__(self, llm, embeddings, dataset_path: str, max_samples: int = 10):
        """
        初始化评估器
    ...
    def evaluate(self) -> EvaluationMetrics:
        ...
        for idx, item in enumerate(tqdm(self.dataset, desc="Evaluating")):
            ...
            # 保存详细结果用于分析
            all_extracted.extend(pred_entities)
            all_ground_truth.extend(gt_entities)
